...
//for test only, do not delete, but can be commented
    public SendRequestXMLResponse sendRequestXML(SendRequestXML sendRequestXML) {
...
//                " \n" +
//                "<AccountAdd>\n" +
//                "<Name>Ellen3 Expense Account</Name>\n" +
//                "<IsActive>1</IsActive>\n" +
////                                "<ParentRef>\n" +
...
//                xml = xml.replace("{{VendorName}}", "Vendor_" + new Random().nextLong());
                System.out.println("222222222hello from ELLEN!!!!!!!!!!!!!!!!!!!!!!!!!");
                sendRequestXMLResponse.setSendRequestXMLResult(XMLRequest);
                System.out.println("333333333hello from ELLEN!!!!!!!!!!!!!!!!!!!!!!!!!");
                stop = true;
            } catch (Exception e) {
