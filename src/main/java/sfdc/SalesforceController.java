...
import com.emoran.QuickbooksActions;
...
public class SalesforceController {
	 ...
	 * @return
	 */
	public static List<String> getApprovedSisteTrakerInvoiceItems(){
			...
			if(projectIds.size() > 0){
				...
				if(invoiceRecords.size() > 0){
					for(Invoice invoiceRecordToCreate:invoiceRecords){
						String quickBooksInsertInvoicePayload = QuickbooksActions.createInvoiceWithCustomFields(invoiceRecordToCreate);
	 ...
	 * @return
	 */
	public static List<Invoice> getProjectsWithFinanceItems(Set<String> setProjectsId){
...
//		getApprovedSisteTrakerInvoiceItems();
		salesforceLogin();
		querySample();
	}
